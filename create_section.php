  ...
  <path fill-rule="evenodd" d="M8 5.754a2.246 2.246 0 1 0 0 4.492 2.246 2.246 0 0 0 0-4.492zM4.754 8a3.246 3.246 0 1 1 6.492 0 3.246 3.246 0 0 1-6.492 0z"/>
	  ...
	  <path fill-rule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z"/>
					        ...
					        <div id="submenu-5" class="collapse submenu submenu-5" data-bs-parent="#menu-accordion">
						        <ul class="submenu-list list-unstyled">
							        <li class="submenu-item"><a class="submenu-link" href="sections.php">Create Sections</a></li>
							        <li class="submenu-item"><a class="submenu-link" href="sections.php">Update Sections</a></li>
						        </ul>
					        </div>
					    </li><!--//nav-item-->
						<li class="nav-item has-submenu">
			...
			<div class="container-xl">
                ...
                <form method="POST">
                    <div class="email mb-3">
                        <input type="text" name="name" class="form-control" placeholder="Session Name" required></b>
                    </div>
                    <div class="email mb-3">
                        <input type="text" name="sem_name" class="form-control" placeholder="Semester Name" required></b>
                    </div>
                    <div class="text-center">
                        <button type="submit" class="btn btn-primary" name="submitBtn">Create Section</button>
                    </div>
                </form>
		    </div><!--//container-fluid-->
	    </div><!--//app-content-->
...
<?php 
    if(isset($_POST['submitBtn'])){
        ...
        // Retrieve the semester_id based on sem_name
        $query = "SELECT semester_id FROM semesters WHERE name='$sem_name'";
        $result = mysqli_query($conn, $query);

        if ($result) {
            // Check if any rows were returned
            if (mysqli_num_rows($result) > 0) {
                // Fetch the semester_id value
                $row = mysqli_fetch_assoc($result);
                $semester_id = $row['semester_id'];

                // Insert the session with the associated semester_id
                $str1 = "INSERT INTO sessions(name, semester_id) VALUES ('$name', $semester_id)";
                ...
                echo "No matching record found for '$sem_name'.";
            }
        } else {
            echo "Error retrieving semester: " . mysqli_error($conn);
        }
    }
?>