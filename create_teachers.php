			...
			<div class="container-xl">
                ...
                <form method="POST">
                    <div class="email mb-3">
                        ...
                        <input type="text" name="name" class="form-control signup-name" placeholder="Name" required></b>
                    </div>
                    <div class="email mb-3">
                        <label class="sr-only" for="">Email</label>
                        <input type="text" name="email" class="form-control signup-email" placeholder="Email" required></b>
                    </div>
                    <div class="email mb-3" >
